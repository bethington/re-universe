...
2. Server: `postgresql://ben:***REDACTED***@localhost:5432/bsim`
3. Enable **"Use SSL"**
4. Test connection
...
./ghidra/Ghidra/RuntimeScripts/Linux/support/bsim postgresql://ben:***REDACTED***@localhost:5432/bsim -addexe /path/to/your/binary.exe
...
# Test SSL connection
PGPASSWORD=***REDACTED*** psql -h localhost -p 5432 -U ben -d bsim -c "SELECT 'SSL test';" --set=sslmode=require
```
