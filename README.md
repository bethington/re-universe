...
2. Server: `postgresql://ben:***REMOVED***@localhost:5432/bsim`
3. Enable **"Use SSL"**
4. Test connection
...
./ghidra/Ghidra/RuntimeScripts/Linux/support/bsim postgresql://ben:***REMOVED***@localhost:5432/bsim -addexe /path/to/your/binary.exe
