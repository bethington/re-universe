...
public class PopulateFunctionSignatures extends GhidraScript {
    ...
    public void run() throws Exception {
        ...
        String selectedMode = askChoice("Select Processing Mode",
            "How would you like to populate function signatures?",
    ...
    private void processSingleProgram() throws Exception {
        ...
        try {
            populateFunctionSignatures(currentProgram, programName);
    ...
    private void processAllPrograms() throws Exception {
        ...
        boolean proceed = askYesNo("Process All Programs",
            String.format("Found %d programs in project.\n\nPopulate function signatures for all programs?",
                programFiles.size()));
    ...
    private void processVersionFiltered() throws Exception {
        ...
        boolean proceed = askYesNo("Process Filtered Programs",
            String.format("Found %d programs matching '%s'.\n\nPopulate function signatures for these programs?",
    ...
    private void processProjectFile(DomainFile file) throws Exception {
        ...
        try {
            populateFunctionSignatures(program, file.getName());
            println("  Function signatures populated successfully");
        } finally {
            program.release(this);
        }
    }

    private void populateFunctionSignatures(Program program, String programName) throws Exception {
